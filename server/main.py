...
QUESTIONS = [{'answer': '<pad> Elephants', 'question': 'What are the largest existing land animals?', 'context': 'Elephants are the largest existing land animals.'}, {'answer': '<pad> three', 'question': 'How many living species are elephants currently recognised?', 'context': 'Three living species are currently recognised: the African bush elephant, the African forest elephant, and the Asian elephant.'}, {'answer': '<pad> Elephantidae', 'question': 'What is the only surviving family of proboscideans?', 'context': 'They are an informal grouping within the proboscidean family Elephantidae.'}, {'answer': '<pad> mastodons', 'question': 'What are the extinct members of the proboscidean family?', 'context': 'Elephantidae is the only surviving family of proboscideans; extinct members include the mastodons.'},
             {'answer': '<pad> mammoths and straight-tusked elephants', 'question': 'What are the extinct groups of elephantidae?', 'context': 'Elephantidae also contains several extinct groups, including the mammoths and straight-tusked elephants.'}, {'answer': '<pad> larger ears and concave backs', 'question': 'What do African elephants have?',
                                                                                                                                                                                                                                                             'context': 'African elephants have larger ears and concave backs, whereas Asian elephants have smaller ears, and convex or level backs.'}, {'answer': '<pad> a trunk, tusks, large ear flaps, massive legs, and tough but sensitive skin', 'question': 'What is a long proboscis called?', 'context': 'Distinctive features of all elephants include a long proboscis called a trunk, tusks, large ear flaps, massive legs, and tough but sensitive skin.'},
             {'answer': '<pad> breathing, bringing food and water to the mouth, and grasping objects', 'question': 'What is the trunk used for?', 'context': 'The trunk is used for breathing, bringing food and water to the mouth, and grasping objects.'}, {'answer': '<pad> Tusks', 'question': 'What is derived from the incisor teeth?', 'context': 'Tusks, which are derived from the incisor teeth, serve both as weapons and as tools for moving objects and digging.'}, {'answer': '<pad> The large ear flaps', 'question': 'What aids in maintaining a constant body temperature?', 'context': 'The large ear flaps assist in maintaining a constant body temperature as well as in communication.'}, {'answer': '<pad> The pillar-like legs', 'question': 'What type of legs carry their great weight?',
