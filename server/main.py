...
async def generateQuestions(req: Body):
    ...
    for ques in QUESTIONS:
        questions.append(getOptions(ques)) #TODO: Remove answer from options and match case 
